...
@Service
public class RuLocaleProcessor extends MainMenuKeyboardProcessor {

    private final LanguageCache languageCache;

    public RuLocaleProcessor(BotStateService botStateService, KeyBoardService keyBoardService,
    ...
    public SendMessage process(Long chatId, Long userId, String text, String userRole) {
        languageCache.addData(userId, MainMenuButtonName.ru.toString());
